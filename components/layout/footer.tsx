    ...
    <footer className="border-t border-white/[0.07] pb-8 pt-14">
      <div className="container-shell">
        <Stagger className="grid gap-12 md:grid-cols-[1.3fr_1fr]" stagger={0.14}>
          <StaggerItem preset="tilt"><Logo /><p className="mt-5 max-w-xs text-sm leading-6 text-[#6f7774]">The living intelligence layer for companies that choose to stay close to their customers.</p><div className="mt-5 flex flex-col gap-1"><p className="text-[10px] font-medium uppercase tracking-[0.12em] text-[#4f5754]">Co-founders</p><p className="mt-1 text-xs text-[#aeb6b2]">Kaushal Tiwari <span className="text-[#5e6662]">&</span> Namrata Jhade</p></div><a href="mailto:hello@sentiloop.ai" className="mt-5 inline-flex items-center gap-2 text-xs text-[#aeb6b2] hover:text-white">hello@sentiloop.ai <ArrowUpRight size={13} /></a></StaggerItem>
